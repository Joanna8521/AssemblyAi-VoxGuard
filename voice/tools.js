...
export function systemPrompt(corpus) {
  ...
  return [
    ...
    `  Google Drive, spreadsheets, a Shopify admin, an ad account or an order`,
    `  database, whatever those words might suggest. What is actually connected is`,
    `  narrow and worth knowing:`,
    ``,
