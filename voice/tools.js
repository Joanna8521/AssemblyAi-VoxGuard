...
export function systemPrompt(corpus) {
  ...
  return [
    ...
    ``,
    `RULES`,
    `- People pause mid-thought. "Watch my takings and tell me when they drop."`,
    `  [pause] "Never touch prices." is one instruction, not two. Carry the earlier`,
    `  turn forward and call start_mission with both. Never let work described in`,
    `  any turn go without a mission; open it on what you have and amend later.`,
