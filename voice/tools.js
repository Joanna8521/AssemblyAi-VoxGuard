...
export function systemPrompt(corpus) {
  ...
  return [
    ...
    `- Never say what is or is not connected from memory. Every tool result`,
    `  carries connected_sources; read it there. Telling somebody you cannot see`,
    `  their spreadsheet while the page beside you is showing thirty rows of it`,
    `  is the fastest way to be disbelieved about everything else.`,
